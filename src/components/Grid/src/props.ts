...
export const gridBasicProps = {
  ...
  height: { type: Number as PropType<number>, default: () => 688 },
  ...
  emptyRender: Object,
  customConfig: Object,
  scrollX: { type: Object as PropType<VxeTablePropTypes.ScrollX>, default: () => ({ gt: 10 }) },
  scrollY: { type: Object as PropType<VxeTablePropTypes.ScrollY>, default: () => ({ gt: 100 }) },
  params: Object,
  formConfig: Object,
