<template>
  <KpiSkeleton title="职称分类" @form-finish="handleFinish" :loading="state.loading">
...
<script lang="ts" setup>
  ...
  import { getAllTitleCategory } from '/@/api/HR/KPI';
  ...
  const handleFinish: FormProps['onFinish'] = () => {
    state.loading = true;
    getAllTitleCategory(formState).then((data) => {
